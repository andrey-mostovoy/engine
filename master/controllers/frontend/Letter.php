 ...
 * @author		amostovoy
 */
class LetterController extends AdminLikePagesController
{
    protected function _init()
    {
        parent::_init();
        
        $this->setSelectedMainMenu('letter');
        $this->setSelectedLeftMenu('letter');
    }
...
/* Location: ./controllers/frontend/Letter.php */
?>