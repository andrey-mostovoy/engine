 ...
 * @author		amostovoy
 */
class ApplicationController extends AdminLikePagesController
{
    protected function _init()
    {
        parent::_init();
        
        $this->setSelectedMainMenu('application');
        $this->setSelectedLeftMenu('application');
    }
...
/* Location: ./controllers/frontend/Application.php */
?>