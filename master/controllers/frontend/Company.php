 ...
 * @author		amostovoy
 */
class CompanyController extends AdminLikePagesController
{
    protected function _init()
    {
        parent::_init();
        
        $this->setSelectedMainMenu('company');
        $this->setSelectedLeftMenu('company');
    }
...
/* Location: ./controllers/frontend/Company.php */
?>